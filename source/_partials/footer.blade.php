    ...
    <div class="container has-text-centered">
        <div class="columns">
            ...
            <div class="column is-3 has-text-right-tablet">
                <a href="https://twitter.com/{{ $page->owner->twitter }}" target="_blank" rel="noopener" title="Twitter">
                    <icon stack="fa-square" icon-class="has-text-primary" stack-class="has-text-white">fa-twitter</icon>
                </a>
                <a href="https://github.com/{{ $page->owner->github }}" target="_blank" rel="noopener" title="GitHub">
                    <icon stack="fa-square" icon-class="has-text-primary" stack-class="has-text-white">fa-github</icon>
                </a>
                <a href="https://gitlab.com/{{ $page->owner->gitlab }}" target="_blank" rel="noopener" title="GitLab">
